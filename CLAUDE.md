...
- **Routes:** `/` (landing) · `/passport` (compliance flow) · `/deal-room` (gated app) · `/markets` (the hook demo) · `/concierge` (the agent demo). The last two are placeholders until plan tasks 6 and 7 land.
